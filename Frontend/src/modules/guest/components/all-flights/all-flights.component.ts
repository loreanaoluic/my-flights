...
export class AllFlightsComponent implements OnInit {
            ...
            if (this.isReturnInit) {
              ...
              for (var f of flight[1]) {  
                ...
                if (flight[1][i+1] != null) {
                  ...
                  time_start.setHours(Number(splittedArrivalTime[1]), Number(splittedArrivalTime[1]), 0, 0)
                  time_end.setHours(Number(splittedDepartureTime[1]), Number(splittedDepartureTime[1]), 0, 0)
  ...
  sortFlights() {
    ...
    this.guestService.sortFlights(sort, flyingFrom, flyingTo, departing, returning, passengerNumber, travelClass, 
